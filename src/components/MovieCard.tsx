...
const MovieCard = ({ poster, title, imdbID }: any) => {
  ...
  return (
    <article>
      <div className="relative w-60 h-96 border-2 border-yellow-500 opacity-90 rounded-xl hover:opacity-100 hover:scale-[1.02] hover:cursor-pointer transition-all">
